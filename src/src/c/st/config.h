 ...
 */
char *utmp = NULL;
static char *shell = "{{ printf %s $SHELL }}";
 ...
 * By default, numlock (Mod2Mask) and
 * keyboard layout (XK_SWITCH_MOD) are ignored.
 */
static uint ignoremod = Mod2Mask|XK_SWITCH_MOD;

/*
 * This is the huge key array which defines all compatibility
 * to the Linux world. Please decide about changes wisely.
 */
static Key key[] = {
 ...
 * Button1Mask is always unset, to make masks match
 * between: ButtonPress, ButtonRelease and MotionNotify.
...
/*
 * Printable characters in ASCII, used to estimate
 * the advance width of single wide characters.
 */
